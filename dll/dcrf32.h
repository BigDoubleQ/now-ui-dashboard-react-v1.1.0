...
__int16 __stdcall dc_setcommtimeout(DWORD lTime_ms,DWORD sTime_ms);
//2.
...
__int16  __stdcall dc_changeb3_hex(HANDLE icdev,unsigned char _SecNr, const char *_KeyA,
							   unsigned char _B0,unsigned char _B1,unsigned char _B2,
							   unsigned char _B3,unsigned char _Bk, const char *_KeyB);
//18.
...
__int16 __stdcall dc_creat_mac_hex(unsigned char KeyLen,unsigned char *Key,unsigned short DataLen,
							unsigned char *Data,unsigned char *InitData,unsigned char AutoFixFlag,
							unsigned char FixChar,unsigned char *MacData);
__int16 __stdcall dc_encrypt( char *key,char *ptrSource, unsigned __int16 msgLen, char *ptrDest);
__int16 __stdcall dc_decrypt( char *key,char *ptrSource, unsigned __int16 msgLen, char *ptrDest);
__int16 __stdcall dc_encrypt_hex( char *key,char *ptrSource, unsigned __int16 msgLen, char *ptrDest);
__int16 __stdcall dc_decrypt_hex( char *key,char *ptrSource, unsigned __int16 msgLen, char *ptrDest);
//------------------------------新增的为了整齐DLL而做的代码------------------------------
...
__int16 __stdcall  dc_displow_T8(HANDLE icdev,unsigned char rs,unsigned char cdata);
...
__int16 __stdcall dc_cpuhotreset(HANDLE icdev,unsigned char *rlen,unsigned char *databuffer);
__int16 __stdcall dc_cpuhotreset_hex(HANDLE icdev,unsigned char *rlen, char *databuffer);

__int16 __stdcall  dc_card_status(HANDLE icdev);

__int16  __stdcall dc_card_n(HANDLE icdev, unsigned char _Mode, unsigned long *SnrLen, unsigned char *_Snr);
__int16  __stdcall dc_card_n_hex(HANDLE icdev, unsigned char _Mode, unsigned long *SnrLen, unsigned char *_Snr);
__int16  __stdcall dc_card_n_number(HANDLE icdev, unsigned char _Mode, char *_Snr);

__int16  __stdcall dc_pass_key_value(HANDLE icdev, unsigned char timeout, char *value);
